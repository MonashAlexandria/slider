  ...
  <div>
      <div style={parentStyle}>
          ...
          <div style={horizontalStyle}>
              ...
              <Slider inverted tipFormatter={percentFormatter} tipTransitionName="rc-slider-tooltip-zoom-down" onChange={log} />
          </div>
      </div>
        ...
        <div style={parentStyle}>
            ...
            <div style={verticalStyle}>
              <p>Basic Slider with `tipFormatter`</p>
              <Slider vertical inverted tipFormatter={percentFormatter} tipTransitionName="rc-slider-tooltip-zoom-down" onChange={log} />
            </div>
      </div>
  </div>
