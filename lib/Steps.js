...
var Steps = (function (_Component) {
    ...
    _createClass(Steps, [{
        ...
        value: function render() {
            ...
            var tooltipName = _props.tooltipName;
            ...
            var elements = this.calcPoints(vertical, inverted, marks, dots, step, min, max).map(function (point) {
                ...
                var tooltipTitle = typeof tooltipName === "function" ? tooltipName(point) : tooltipData[point][tooltipName];
                var tooltipWidth = tooltipTitle.length * 8 + 40;
                return _react2['default'].createElement(
                    'span',
                    { className: pointClassName, style: style, key: point, onMouseEnter: _this.onMouseEnter,
                        onMouseLeave: _this.onMouseLeave },
                    _react2['default'].createElement(
                        'div',
                        { style: { width: tooltipWidth }, className: 'rc-tooltip tooltip' },
                        _react2['default'].createElement(
                            'div',
